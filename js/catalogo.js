document.addEventListener("DOMContentLoaded", () => {
  ...
  const livros = [
    ...
    },
    {
      ...
      preco: 30,
      categoria: "fantasia",
      img: "img/O Senhor dos Anéis A Sociedade do Anel.jpg",
    },
    {
      titulo: "Dom Casmurro",
    ...
    },
    {
      ...
      img: "img/MestradasAsrmas.jpg",
    },
    {
      titulo: "Superman: Paz na Terra",
      autor: "Paul Dini",
      ano: 2000,
      preco: 20.9,
      categoria: "ficcao",
  ...
  function renderizarLivros(lista) {
    ...
    lista.forEach((livro) => {
      ...
      card.innerHTML = `<img src="${livro.img}" class="card-img-top" alt="${
        livro.titulo
      }">
        <div class="card-body">
    ...
    buttons.forEach((button) => {
      button.addEventListener("click", (event) => {
        ...
        if (typeof addToCart === "function") {
          ...
          console.error(
            "Função addToCart não está definida. Certifique-se de que Carrinho.js está carregado."
          );
        }
      });
    });
